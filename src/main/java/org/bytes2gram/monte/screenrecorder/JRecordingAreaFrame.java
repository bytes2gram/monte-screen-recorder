...
public class JRecordingAreaFrame extends javax.swing.JFrame {
  ...
  private void closeButtonPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_closeButtonPerformed
  ...
  private static class JContentPane extends JPanel {
    ...
    protected void paintComponent(Graphics gr) {
      ...
      BasicStroke s = new BasicStroke(3, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 1f,
    ...
    public void mouseDragged(MouseEvent e) {
      ...
      switch (region) {
        ...
        case SwingConstants.SOUTH_EAST:
          setLocation(min(l.x + d.x + s.width - minSize.width, l.x),
              min(l.y + d.y + s.height - minSize.height, l.y));
          setSize(max(minSize.width, s.width + d.x), max(minSize.height, s.height + d.y));
          break;
