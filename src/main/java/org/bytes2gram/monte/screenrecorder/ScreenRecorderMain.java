...
import static org.bytes2gram.monte.media.AudioFormatKeys.EncodingKey;
import static org.bytes2gram.monte.media.AudioFormatKeys.FrameRateKey;
import static org.bytes2gram.monte.media.AudioFormatKeys.KeyFrameIntervalKey;
import static org.bytes2gram.monte.media.AudioFormatKeys.MIME_AVI;
import static org.bytes2gram.monte.media.AudioFormatKeys.MIME_QUICKTIME;
import static org.bytes2gram.monte.media.AudioFormatKeys.MediaType;
import static org.bytes2gram.monte.media.AudioFormatKeys.MediaTypeKey;
import static org.bytes2gram.monte.media.AudioFormatKeys.MimeTypeKey;
...
import static org.bytes2gram.monte.media.VideoFormatKeys.COMPRESSOR_NAME_QUICKTIME_JPEG;
import static org.bytes2gram.monte.media.VideoFormatKeys.COMPRESSOR_NAME_QUICKTIME_PNG;
import static org.bytes2gram.monte.media.VideoFormatKeys.COMPRESSOR_NAME_QUICKTIME_RAW;
...
import static org.bytes2gram.monte.media.VideoFormatKeys.ENCODING_AVI_DIB;
import static org.bytes2gram.monte.media.VideoFormatKeys.ENCODING_AVI_MJPG;
import static org.bytes2gram.monte.media.VideoFormatKeys.ENCODING_AVI_PNG;
import static org.bytes2gram.monte.media.VideoFormatKeys.ENCODING_AVI_RLE;
import static org.bytes2gram.monte.media.VideoFormatKeys.ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE;
import static org.bytes2gram.monte.media.VideoFormatKeys.ENCODING_QUICKTIME_ANIMATION;
import static org.bytes2gram.monte.media.VideoFormatKeys.ENCODING_QUICKTIME_JPEG;
import static org.bytes2gram.monte.media.VideoFormatKeys.ENCODING_QUICKTIME_PNG;
import static org.bytes2gram.monte.media.VideoFormatKeys.ENCODING_QUICKTIME_RAW;
import static org.bytes2gram.monte.media.VideoFormatKeys.HeightKey;
import static org.bytes2gram.monte.media.VideoFormatKeys.QualityKey;
...
import org.bytes2gram.monte.media.gui.JLabelHyperlinkHandler;
import org.bytes2gram.monte.media.gui.Worker;
import org.bytes2gram.monte.media.gui.datatransfer.DropFileTransferHandler;
...
public class ScreenRecorderMain extends javax.swing.JFrame {
  ...
  public ScreenRecorderMain() {
    ...
    movieFolder = new File(prefs.get("org.bytes2gram.monte.ScreenRecorder.movieFolder", movieFolder.toString()));

    final String infoLabelText = infoLabel.getText();
    infoLabel.setText(infoLabelText.replaceAll("\"Movies\"",
        "\"<a href=\"" + movieFolder.toURI() + "\">" + movieFolder.getName() + "</a>\""));
    ...
    infoLabel.setTransferHandler(
        new DropFileTransferHandler(JFileChooser.DIRECTORIES_ONLY, null, new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            movieFolder = new File(e.getActionCommand());
            prefs.put("org.bytes2gram.monte.ScreenRecorder.movieFolder", movieFolder.toString());
            infoLabel.setText(infoLabelText.replaceAll("\"Movies\"",
                "\"<a href=\"" + movieFolder.toURI() + "\">" + movieFolder.getName() + "</a>\""));
          }
        }));

    depth = min(max(0, prefs.getInt("ScreenRecording.colorDepth", 3)),
        colorsChoice.getItemCount() - 1);
    colorsChoice.setSelectedIndex(depth);
    format = min(max(0, prefs.getInt("ScreenRecording.format", 0)),
        formatChoice.getItemCount() - 1);
    formatChoice.setSelectedIndex(format);
    encoding = min(max(0, prefs.getInt("ScreenRecording.encoding", 0)),
        encodingChoice.getItemCount() - 1);
    encodingChoice.setSelectedIndex(encoding);
    cursor = min(max(0, prefs.getInt("ScreenRecording.cursor", 1)),
        cursorChoice.getItemCount() - 1);
    ...
    areaChoice.setModel(new DefaultComboBoxModel(new Object[]{
        ...
        new AreaItem("Custom: " + customLoc.x + ", " + customLoc.y + "; " + customDim.width + " x "
            + customDim.height + "", customDim, null, SwingConstants.NORTH_WEST, customLoc),}));
  ...
  private void initComponents() {
    ...
    cursorChoice.setModel(new javax.swing.DefaultComboBoxModel(
        new String[]{"No Cursor", "Black Cursor", "White Cursor"}));
    ...
    encodingChoice.setModel(new javax.swing.DefaultComboBoxModel(
        new String[]{"Screen Capture", "Run Length", "None", "PNG", "JPEG 100 %", "JPEG   50 %"}));

    areaLabel.setText("Area:");

    areaChoice.setModel(new javax.swing.DefaultComboBoxModel(
        new String[]{"Entire Screen", "0 0,  1024 x 768", " "}));
    ...
    audioSourceChoice
        .setModel(new javax.swing.DefaultComboBoxModel(new String[]{"No Audio", "44.100 kHz"}));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                        layout.createSequentialGroup()
                            .addComponent(stateLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 190,
                            ...
                            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    .addGroup(layout.createParallelGroup(
                                        ...
                                        .addComponent(formatChoice,
                                            javax.swing.GroupLayout.PREFERRED_SIZE,
                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                            javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(colorsChoice,
                                            javax.swing.GroupLayout.PREFERRED_SIZE,
                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                            javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(cursorChoice,
                                            javax.swing.GroupLayout.PREFERRED_SIZE,
                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                            javax.swing.GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addGroup(layout.createParallelGroup(
                                        javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(audioRateChoice,
                                            javax.swing.GroupLayout.PREFERRED_SIZE,
                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                            javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(encodingChoice,
                                            javax.swing.GroupLayout.PREFERRED_SIZE,
                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                            javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(screenRateField,
                                            javax.swing.GroupLayout.PREFERRED_SIZE, 77,
                                            javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(mouseRateField,
                                            javax.swing.GroupLayout.PREFERRED_SIZE, 77,
                                            javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(areaChoice,
                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(
    ...
    layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
        new java.awt.Component[]{audioRateChoice, colorsChoice, cursorChoice, formatChoice});
        ...
        layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(
                            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(formatChoice, javax.swing.GroupLayout.PREFERRED_SIZE,
                                    javax.swing.GroupLayout.DEFAULT_SIZE,
                                    javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(formatLabel))
                        ...
                        .addGroup(
                            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(colorsChoice, javax.swing.GroupLayout.PREFERRED_SIZE,
                                    javax.swing.GroupLayout.DEFAULT_SIZE,
                                    javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(colorsLabel))
                        .addGap(11, 11, 11)
                        .addGroup(
                            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(cursorChoice, javax.swing.GroupLayout.PREFERRED_SIZE,
                                    javax.swing.GroupLayout.DEFAULT_SIZE,
                                    javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(mouseLabel)))
                    .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(audioRateChoice, javax.swing.GroupLayout.PREFERRED_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(audioRateLabel)
                    .addComponent(audioSourceLabel)
                    .addComponent(audioSourceChoice, javax.swing.GroupLayout.PREFERRED_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(areaChoice, javax.swing.GroupLayout.PREFERRED_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(areaLabel)
                    .addComponent(selectAreaButton))
      ...
      case 0: // AVI
        encodingChoice.setModel(
            new javax.swing.DefaultComboBoxModel(
                new String[]{"Screen Capture", "Run Length", "None", "PNG", "JPEG 100 %",
                    "JPEG  50 %"}));
        break;
      case 1: // QuickTime
        encodingChoice.setModel(
            new javax.swing.DefaultComboBoxModel(
                new String[]{"Screen Capture", "Animation", "None", "PNG", "JPEG 100 %",
                    "JPEG  50 %"}));
        break;
    }
  ...
  private void startStopPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startStopPerformed
    if (screenRecorder == null) {
  ...
  private void formWindowDeiconified(
      java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowDeiconified
    // stop();
  }//GEN-LAST:event_formWindowDeiconified

  private void formatChoicePerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_formatChoicePerformed
    updateEncodingChoice();
  }//GEN-LAST:event_formatChoicePerformed

  private void selectAreaPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectAreaPerformed
    ...
    f.addWindowListener(new WindowAdapter() {
      ...
      public void windowClosed(WindowEvent e) {
        ...
        ai.title =
            "Custom: " + ai.location.x + ", " + ai.location.y + "; " + ai.inputDimension.width
                + " x " + ai.inputDimension.height;
        f.setVisible(false);
        f.dispose();
        setVisible(true);
