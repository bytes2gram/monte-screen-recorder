...
public class Format {
      ...
      for (Map.Entry<FormatKey, Object> e : properties.entrySet()) {
        if (!e.getKey().isAssignable(e.getValue())) {
          throw new ClassCastException(
              e.getValue() + " must be of type " + e.getKey().getValueClass());
        }
      }
  ...
  /**
   * Returns true if that format matches this format. That is iff all properties defined in both
   * format objects are identical. Properties which are only defined in one of the format objects
   * are not considered.
   *
   ...
   * from that format. <p> If a property is specified in both formats, then the property value from
   * this format is used. It overwrites that format. <p> If one of the format has more properties
   * than the other, then the new format is more specific than this format.
   *
   * @param that
  ...
  /**
   * Creates a new format which contains all properties from this format and additional properties
   * listed. <p> If a property is specified in both formats, then the property value from this
   * format is used. It overwrites that format. <p> If one of the format has more properties than
  ...
  /**
   * Creates a new format which contains all properties from the specified format and additional
   * properties from this format.
  ...
  /**
   * Creates a new format which only has the specified keys (or less). <p> If the keys are reduced,
   * then the new format is less specific than this format.
   */
  ...
  /**
   * Creates a new format without the specified keys. <p> If the keys are reduced, then the new
   * format is less specific than this format.
   */
