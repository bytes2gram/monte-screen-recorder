...
/**
 * {@code JLabelHyperlinkHandler} makes HTML hyperlinks in a {@code JLabel} clickable.
 * <p>
 * You can add an action listener to this handler to perform the desired action. The {@code command}
 * contains the content of the href attribute in the hyperlink.
 * <p>
 * Example:
 * <pre>
