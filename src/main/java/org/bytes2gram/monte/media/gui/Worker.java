 ...
 */
package org.bytes2gram.monte.media.gui;

import javax.swing.SwingUtilities;

/**
 * This is an abstract class that you can subclass to perform GUI-related work in a dedicated event
 * dispatcher.
 * <p>
...
public abstract class Worker<T> implements Runnable {
   ...
   * <code>construct</code> method has returned without throwing an error.
   * <p>
   * The default implementation does nothing. Subclasses may override this method to perform done
  ...
  /**
   * Called on the event dispatching thread (not on the worker thread) after the
   * <code>construct</code> method has thrown an error.
   * <p>
   * The default implementation prints a stack trace. Subclasses may override this method to perform
   * failure actions on the Event Dispatch Thread.
   *
  ...
  /**
   * Called on the event dispatching thread (not on the worker thread) after the
   * <code>construct</code> method has finished and after done() or failed() has been invoked.
   * <p>
   * The default implementation does nothing. Subclasses may override this method to perform
   * completion actions on the Event Dispatch Thread.
   */
