...
/**
 * An implementation of {@code ImageInputStream} that gets its input from a regular {@code
 * InputStream}. No caching is used and thus backward seeking is not supported.
 *
