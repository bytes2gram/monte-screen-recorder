...
/**
 * Adapts an {@code ImageOutputStream} for classes requiring an {@code OutputStream}.
 *
...
public class ImageOutputStreamAdapter extends OutputStream {
   ...
   * <p>
   * The <code>write</code> method of <code>FilterOutputStream</code> calls its <code>write</code>
   * method of three arguments with the arguments <code>b</code>, <code>0</code>, and
   * <code>b.length</code>.
   * <p>
   ...
   * <p>
   * Note that this method does not call the <code>write</code> method of its underlying input
   * stream with the same arguments. Subclasses of <code>FilterOutputStream</code> should provide a
