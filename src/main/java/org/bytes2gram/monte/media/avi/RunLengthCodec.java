 ...
 * <p>
 * This codec only works with the AVI file format. Other formats, such as QuickTime, use a different
 * encoding for run-length compressed video.
 * <p>
 * This codec currently only supports encoding from a {@code BufferedImage} into the file format.
 * Decoding support may be added in the future.
 * <p>
...
public class RunLengthCodec extends AbstractVideoCodec {
   ...
   */
  public void writeKey8(OutputStream out, byte[] data, int width, int height, int offset,
   ...
   * @param scanlineStride The number to append to offset to get to the next scanline.
   */
  public void writeKey8(ImageOutputStream out, byte[] data, int width, int height, int offset,
      int scanlineStride)
      throws IOException {
   ...
   * @param scanlineStride The number to append to offset to get to the next scanline.
   */
  public void writeDelta8(OutputStream out, byte[] data, byte[] prev, int width, int height,
      int offset, int scanlineStride) throws IOException {
    ByteArrayImageOutputStream buf = new ByteArrayImageOutputStream(data.length);
   ...
   * @param scanlineStride The number to append to offset to get to the next scanline.
   */
  public void writeDelta8(ImageOutputStream out, byte[] data, byte[] prev, int width, int height,
