...
import org.bytes2gram.monte.media.AbstractVideoCodecCore;
...
import org.bytes2gram.monte.media.io.UncachedImageInputStream;
...
public class TechSmithCodecCore extends AbstractVideoCodecCore {
  ...
  public void decodePalette(byte[] inDat, int off, int len) throws IOException {
    getPalette();
    ByteArrayImageInputStream in = new ByteArrayImageInputStream(inDat, off, len,
   ...
   * @param length
   * @param outDat
   * @param prevDat              The pixels decoded in the previous frame. Since no double buffering
   *                             is used, this can be the same array than {@code outDat}.
   * @param width
   * @param height
   ...
   * @throws IOException
   */
  public boolean decode8(byte[] inDat, int off, int length, byte[] outDat, byte[] prevDat,
      int width, int height, boolean onlyDecodeIfKeyframe) throws IOException {
   ...
   * @throws IOException
   */
  public boolean decode8(byte[] inDat, int off, int length, int[] outDat, int[] prevDat, int width,
      int height, boolean onlyDecodeIfKeyframe) throws IOException {
    // Handle delta frame with all identical pixels
    if (length <= 2) {
      return false;
    }
   ...
   */
  public boolean decode24(byte[] inDat, int off, int length, int[] outDat, int[] prevDat, int width,
      int height, boolean onlyDecodeIfKeyframe) throws IOException {
    // Handle delta frame with all identical pixels
    if (length <= 2) {
      return false;
   ...
   */
  public boolean decode16(byte[] inDat, int off, int length, int[] outDat, int[] prevDat, int width,
      int height, boolean onlyDecodeIfKeyframe) throws IOException {
    // Handle delta frame with all identical pixels
    if (length <= 2) {
      if (outDat != prevDat) {
   ...
   */
  public void encodeDelta8(OutputStream out, byte[] data, byte[] prev, int width, int height,
   ...
   * @param scanlineStride The number to add to offset to get to the next scanline.
   */
  public void encodeDelta8to24(OutputStream out, byte[] data, byte[] prev, int width, int height,
      int offset, int scanlineStride)
      throws IOException {
   ...
   * @throws IOException
   */
  public void encodeSameDelta8(OutputStream out, byte[] data, byte[] prev, int width, int height,
      int offset, int scanlineStride)
      throws IOException {
        /*
   ...
   * @throws IOException
   */
  public void encodeSameDelta24(OutputStream out, int[] data, int[] prev, int width, int height,
      int offset, int scanlineStride)
      throws IOException {
        /*
        temp.clear();temp.setByteOrder(ByteOrder.LITTLE_ENDIAN);
   ...
   * @throws IOException
   */
  public void encodeSameDelta16(OutputStream out, short[] data, short[] prev, int width, int height,
      int offset, int scanlineStride)
      throws IOException {
        /*
        temp.clear();temp.setByteOrder(ByteOrder.LITTLE_ENDIAN);
   ...
   * @param scanlineStride The number to add to offset to get to the next scanline.
   */
  public void encodeKey8(OutputStream out, byte[] data, int width, int height, int offset,
      int scanlineStride)
      throws IOException {
    temp.clear();
    temp.setByteOrder(ByteOrder.LITTLE_ENDIAN);
   ...
   * @param scanlineStride The number to add to offset to get to the next scanline.
   */
  public void encodeKey8to24(OutputStream out, byte[] data, int width, int height, int offset,
      int scanlineStride)
      throws IOException {
    temp.clear();
    temp.setByteOrder(ByteOrder.LITTLE_ENDIAN);
   ...
   * @param scanlineStride The number to add to offset to get to the next scanline.
   */
  public void encodeDelta16(OutputStream out, short[] data, short[] prev, int width, int height,
      int offset, int scanlineStride)
      throws IOException {
   ...
   * @param scanlineStride The number to add to offset to get to the next scanline.
   */
  public void encodeKey24(OutputStream out, int[] data, int width, int height, int offset,
      int scanlineStride)
      throws IOException {
    temp.clear();
    temp.setByteOrder(ByteOrder.LITTLE_ENDIAN);
   ...
   * @param scanlineStride The number to add to offset to get to the next scanline.
   */
  public void encodeDelta24(OutputStream out, int[] data, int[] prev, int width, int height,
      int offset, int scanlineStride)
      throws IOException {
   ...
   * @param scanlineStride The number to add to offset to get to the next scanline.
   */
  public void encodeKey16(OutputStream out, short[] data, int width, int height, int offset,
      int scanlineStride)
      throws IOException {
    temp.clear();
    temp.setByteOrder(ByteOrder.LITTLE_ENDIAN);
