...
/**
 * RIFFVIsitor is notified each time the RIFFParser visits a data chunk and when a group is entered
 * or leaved.
 *
...
public interface RIFFVisitor {
  ...
  /**
   * This method is invoked when the parser attempts to enter a group. The visitor can return false,
   * if the parse shall skip the group contents.
   *
   * @param group
