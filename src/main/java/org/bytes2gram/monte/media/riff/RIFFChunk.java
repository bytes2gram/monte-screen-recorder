...
public class RIFFChunk {
  ...
  /**
   * This is used to display parser messages, when the parser encounters and error while parsing the
   * chunk.
   */
  ...
  public String toString() {
    return super.toString() + "{" + RIFFParser.idToString(getType()) + "," + RIFFParser
        .idToString(getID()) + "}";
  }
}
