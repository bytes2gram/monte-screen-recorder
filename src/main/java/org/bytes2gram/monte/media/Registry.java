...
public abstract class Registry {
  ...
  /**
   * Gets all codecs which can transcode from the specified input format to the specified output
   * format.
   *
  ...
  /**
   * Gets a codec which can transcode from the specified input format to the specified output
   * format.
   *
   * @param inputFormat  The input format.
   * @param outputFormat The output format.
   ...
   *
   * @param fileFormat  The file format, e.g."video/avi", "video/quicktime". Use "Java" for formats
   *                    which are not tied to a file format. Must not be null.
