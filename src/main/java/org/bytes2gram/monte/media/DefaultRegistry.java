 ...
 */
package org.bytes2gram.monte.media;

import static org.bytes2gram.monte.media.AudioFormatKeys.ENCODING_AVI_PCM;
...
import static org.bytes2gram.monte.media.AudioFormatKeys.ENCODING_QUICKTIME_IN24_PCM;
import static org.bytes2gram.monte.media.AudioFormatKeys.ENCODING_QUICKTIME_IN32_PCM;
import static org.bytes2gram.monte.media.AudioFormatKeys.ENCODING_QUICKTIME_RAW_PCM;
import static org.bytes2gram.monte.media.AudioFormatKeys.ENCODING_QUICKTIME_SOWT_PCM;
...
import static org.bytes2gram.monte.media.VideoFormatKeys.MIME_ANIM;
...
public class DefaultRegistry extends Registry {
  ...
  protected void init() {
    ...
    // --------
    putCodec(
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_JAVA, EncodingKey,
            VideoFormatKeys.ENCODING_BUFFERED_IMAGE),
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_ANIM, EncodingKey,
            VideoFormatKeys.ENCODING_BITMAP_IMAGE),
    ...
    putBidiCodec(
        ...
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_AVI, EncodingKey,
            VideoFormatKeys.ENCODING_AVI_DIB),
    ...
    putCodec(
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_JAVA, EncodingKey,
            VideoFormatKeys.ENCODING_BUFFERED_IMAGE),
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_AVI, EncodingKey,
            VideoFormatKeys.ENCODING_AVI_PNG),
    ...
    putCodec(
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_JAVA, EncodingKey,
            VideoFormatKeys.ENCODING_BUFFERED_IMAGE),
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_AVI, EncodingKey,
            VideoFormatKeys.ENCODING_AVI_RLE),
    ...
    putCodec(
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_AVI, EncodingKey,
            VideoFormatKeys.ENCODING_AVI_DOSBOX_SCREEN_CAPTURE),
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_JAVA, EncodingKey,
            VideoFormatKeys.ENCODING_BUFFERED_IMAGE),
        "org.monte.media.avi.ZMBVCodec");

    putBidiCodec(
        new Format(MediaTypeKey, MediaType.AUDIO, MimeTypeKey, MIME_JAVA, EncodingKey,
            ENCODING_PCM_SIGNED),
        new Format(MediaTypeKey, MediaType.AUDIO, MimeTypeKey, MIME_AVI, EncodingKey,
            ENCODING_AVI_PCM),
    ...
    putCodec(
        ...
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_QUICKTIME, EncodingKey,
            VideoFormatKeys.ENCODING_QUICKTIME_RAW),
    ...
    putBidiCodec(
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_JAVA, EncodingKey,
            VideoFormatKeys.ENCODING_BUFFERED_IMAGE),
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_QUICKTIME, EncodingKey,
            VideoFormatKeys.ENCODING_QUICKTIME_JPEG),
        "org.monte.media.jpeg.JPEGCodec");
    putBidiCodec(
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_JAVA, EncodingKey,
            VideoFormatKeys.ENCODING_BUFFERED_IMAGE),
    ...
    putBidiCodec(
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_QUICKTIME,
            EncodingKey, VideoFormatKeys.ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE,
            VideoFormatKeys.CompressorNameKey,
            VideoFormatKeys.COMPRESSOR_NAME_AVI_TECHSMITH_SCREEN_CAPTURE),
        new Format(MediaTypeKey, MediaType.VIDEO, MimeTypeKey, MIME_JAVA, EncodingKey,
            VideoFormatKeys.ENCODING_BUFFERED_IMAGE),
        "org.monte.media.avi.TechSmithCodec");
    ...
    putCodec(
        new Format(MediaTypeKey, MediaType.AUDIO, MimeTypeKey, MIME_JAVA, EncodingKey,
            ENCODING_PCM_SIGNED),
        new Format(MediaTypeKey, MediaType.AUDIO, MimeTypeKey, MIME_QUICKTIME, EncodingKey,
    ...
    putReader(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_AVI),
        "org.monte.media.avi.AVIReader");
    putReader(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_QUICKTIME),
        "org.monte.media.quicktime.QuickTimeReader");
    putReader(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_ANIM),
        "org.monte.media.anim.ANIMReader");
    putWriter(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_AVI),
        "org.monte.media.avi.AVIWriter");
    putWriter(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_QUICKTIME),
        "org.monte.media.quicktime.QuickTimeWriter");
    putWriter(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_ANIM),
  ...
  public String[] getCodecClasses(Format inputFormat, Format outputFormat) {
    ...
    for (RegistryEntry e : entries) {
      if ((inputFormat == null || e.inputFormat == null || inputFormat.matches(e.inputFormat))
          && (outputFormat == null || e.outputFormat == null || outputFormat
          .matches(e.outputFormat))) {
