...
import org.bytes2gram.monte.media.avi.AVIBMPDIB;
 ...
 * <p>
 * For more information see: Microsoft Windows Bitmap Format. Multimedia Technical Note: JPEG DIB
...
public class MJPGImageReader extends ImageReader {
  ...
  public Iterator<ImageTypeSpecifier> getImageTypes(int imageIndex) throws IOException {
    ...
    l.add(new ImageTypeSpecifier(RGB,
        RGB.createCompatibleSampleModel(image.getWidth(), image.getHeight())));
    return l.iterator();
  }
  ...
  /**
   * Reads the image header. Does nothing if the header has already been loaded.
   */
