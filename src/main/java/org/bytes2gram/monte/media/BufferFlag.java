...
public enum BufferFlag {
   ...
   * <p>
   * This flag is used when the media time of a track is set to a non-keyframe sample. Thus decoding
   * must start at a keyframe at an earlier time.
   * <p>
   * Decoders should decode the buffer. Encoders and Multiplexers should discard the buffer.
   */
  PREFETCH,
  /**
   * Indicates that this buffer is known to have the same data as the previous buffer. This may
