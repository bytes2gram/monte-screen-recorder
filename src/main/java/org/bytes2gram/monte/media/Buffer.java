...
import org.bytes2gram.monte.media.util.Methods;
...
public class Buffer {
  ...
  public int length;
  /**
   * Duration of a sample in seconds. Multiply this with {@code sampleCount} to get the buffer
   * duration.
   */
  ...
  /**
   * Sets all variables of this buffer to that buffer except for {@code data}, {@code offset},
   * {@code length} and {@code header}.
   */
  ...
  /**
   * Sets {@code data}, {@code offset}, {@code length} and {@code header} of this buffer to that
   * buffer. Note that this method creates copies of the {@code data} and {@code header}, so that
   * these fields in that buffer can be discarded without affecting the contents of this buffer.
   * <p>
