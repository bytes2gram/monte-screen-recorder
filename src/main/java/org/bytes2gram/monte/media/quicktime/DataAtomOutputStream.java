/**
 * @(#)DataAtomOutputStream.java Copyright (c) 2008-2012 Werner Randelshofer, Goldau, Switzerland.
 * All rights reserved.
 * <p>
...
public class DataAtomOutputStream extends FilterOutputStream {
  ...
  protected static final long MAC_TIMESTAMP_EPOCH = new GregorianCalendar(1904,
      GregorianCalendar.JANUARY, 1).getTimeInMillis();
  /**
